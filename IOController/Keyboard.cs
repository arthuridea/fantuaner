...
namespace ControlEngine
{
    ...
    /// 键盘类
    /// </summary>
    public sealed class CKeyboard : CInput
    {
        /// <summary>
        /// 控制台句柄
        /// </summary>
        ...
        /// <param name="e"></param>
        public delegate void CKeyboardHandler<TEventArgs>(TEventArgs e);
        /// <summary>
        /// 键盘按下事件
        /// </summary>
        ...
        private Boolean IsCurrentWindow()
        {
            try
            {
                IntPtr cwindow = GetForegroundWindow();
        ...
        {
            return (0 != (GetAsyncKeyState((Int32)vKey) & KEY_STATE)) && IsCurrentWindow();
        }
